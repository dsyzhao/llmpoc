...
response_agent = bedrock_agent_client.create_agent(
    ...
    memoryConfiguration={
        ...
        "storageDays": memory_time
    }
)
print(response_agent)

# %%
agent_id = response_agent['agent']['agentId']
...
# %%
response_prep_agent = bedrock_agent_client.prepare_agent(
    agentId=agent_id
)
print(response_prep_agent)
...
response_guardrail = bedrock_agent_client.create_guardrail(
    name="hvt-guardrails",
...
guardrailId = response_guardrail["guardrailId"]
print("The guardrail id is",response_guardrail["guardrailId"])
...
# %%
response_agent_alias = bedrock_agent_client.create_agent_alias(
    agentAliasName='your alias name',
    agentId=agent_id,
    description='description of your new alias'
)
print(response_agent_alias)